...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo site_url()?>"><?php echo $title2?></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo site_url('admin/auth')?>" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" name="email" id="email" class="form-control" value="<?php echo set_value('email')?>" placeholder="Email or Username">
