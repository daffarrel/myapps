...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <section class="content-header">
        <h1>Master Data Truck</h1>
        <ol class="breadcrumb">
          <li><a href="<?php echo base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="#"> Master Data</a></li>
          <li class="active"><a href="#"> Data Truck</a></li>
        </ol>
      </section>
...
<script type="text/javascript">
    ...
    function add(){
        ...
        $('.modal-title').text('Tambah Data Truck'); // Set title to Bootstrap modal title
    }
    ...
    function edit(id){
        ...
        $.ajax({
            url : "<?php echo site_url('truck/ajax_edit/')?>" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {		
                $('#idm').val(data.idm_truck);
                $('#kode_truk').val(data.truck_code);
                $('#no_polisi').val(data.plate_number);

                $('#md-form').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Edit Data Truck'); // Set title to Bootstrap modal title
            },
    ...
    function save(){    
        ...
        url = "<?php echo site_url('truck/ajax_save');?>";
    ...
    $(document).ready(function(){
        table= $('#tabel').DataTable({
            ...
            ajax: {
                "url": "<?php echo site_url('truck/ajax_list')?>" ,
                "type": "POST",
            },
        });
    });
    ...
    function del(id) {
        swal.fire({
            ...
            if (willDelete.value) {
                $.ajax({
                    url : "<?php echo site_url('truck/delete')?>/"+id,
                    type: "POST",
                    dataType: "JSON",
                    success: function(data)
                    {
