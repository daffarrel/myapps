    ...
    <div class="container-fluid">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><a href="#"> Data Bank</a></li>
        </ol>
      </section>
...
<script type="text/javascript">
    ...
    function add(){
        ...
        $('.modal-title').text('Tambah Data Bank'); // Set title to Bootstrap modal title
    }
    ...
    function edit(id){
        ...
        $.ajax({
            ...
            {		
                $('#idm').val(data.idm_bank);
                $('#bank_code').val(data.bank_code);
                $('#bank_name').val(data.bank_name);

                $('#md-form').modal('show'); // show bootstrap modal when complete loaded
                $('.modal-title').text('Edit Data Bank'); // Set title to Bootstrap modal title
            },
    ...
    function save(){    
        ...
        url = "<?php echo site_url('bank/ajax_save');?>";
