                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input required id="nama_supir" name="nama_supir" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="agent_name" class="form-label">No Sim</label>
                                    <input required id="no_sim" name="no_sim" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="agent_name" class="form-label">Tempat Lahir</label>
                                    <input required id="tmpt_lahir" name="tmpt_lahir" class="form-control" type="text">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="agent_name" class="form-label">Tanggal Lahir</label>
                                    <input required id="tgl_lahir" name="tgl_lahir" class="form-control tanggal" type="text">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    function edit(id){
        ...
        $.ajax({
            ...
            {		
                $('#idm').val(data.idm_driver);
                $('#nama_supir').val(data.driver_name);
                $('#no_sim').val(data.license_number);
                $('#tmpt_lahir').val(data.dob_city);
                $('#tgl_lahir').val(data.dob);
    ...
    function save(){    
        ...
        url = "<?php echo site_url('driver/ajax_save');?>";
