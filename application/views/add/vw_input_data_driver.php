    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Input Data Supir</h2>
                    </div>
                    <div class="body">
                        <?php echo $this->session->flashdata('notif');?>
                        <form id="form_input" action="<?php echo base_url('driver/addData')?>" method="POST" enctype="multipart/form-data">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                            <input required id="tgl_lahir" name="tgl_lahir" class="form-control datepicker" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
